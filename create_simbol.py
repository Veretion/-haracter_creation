...
for i in range(3):
	for ii in range(3):
		'''[id, mass_points, state(disable/enable), start_point, end_point]'''
		mass.append([str(l_id), led_horiz(x_int+xx, y_int+yy, 5, long), 'disable', [x_int+xx, y_int+yy], [x_int+long+xx, y_int+yy]])
		mass.append([str(l_id+1), led_vertic(x_int+xx, y_int+yy, 5, long), 'disable', [x_int+xx, y_int+yy], [x_int+xx, y_int+long+yy]])
		mass.append([str(l_id+2), led_dig1(x_int+xx, y_int+yy, 7, long), 'disable', [x_int+xx, y_int+yy], [x_int+long+xx, y_int+long+yy]])
		mass.append([str(l_id+3), led_dig2(x_int+long+xx, y_int+yy, 7, long), 'disable', [x_int+long+xx, y_int+yy], [x_int+xx, y_int+long+yy]])
...
xx = long*3
for i in range(3):
	mass.append([str(l_id), led_vertic(x_int+xx, y_int+yy, 5, long), 'disable', [x_int+xx, y_int+yy], [x_int+xx, y_int+long+yy]])
	yy += long
	l_id += 1
